  ...
  return (
    <div className="space-y-5">
      {publications.map((publication, index) => (
        <article
          key={index}
          className="grid gap-4 rounded-md py-2 transition-colors hover:bg-back-secondary/50 sm:grid-cols-[152px_1fr]"
        >
          <div className="relative aspect-[16/10] w-full overflow-hidden rounded-sm bg-back-secondary sm:w-[152px]">
            <Image
          ...
          <div>
            ...
            <h2 className="text-[15px] font-semibold leading-tight text-teal-700 dark:text-teal-400">
            ...
            <p className="mt-1.5 text-sm leading-5 text-fore-subtle">
            ...
            <p className="mt-1 text-sm leading-5 text-fore-subtle">
              {publication.venue}
            </p>
            {publication.award ? (
              <p className="mt-1 text-sm font-medium leading-5 text-fore-primary">
                {publication.award}
              </p>
            ) : null}
            <p className="mt-1.5 flex flex-wrap gap-x-2 gap-y-1 text-sm leading-5">
